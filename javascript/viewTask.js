document.getElementById('if28b').onclick = (event) => {
    ...
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('iyhvh').onclick = (event) => {
    event.preventDefault();
    ...
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('ihfax').onclick = (event) => {
    event.preventDefault();
    ...
    { 
     ...
     location.href= '//' + transitionId;}};document.getElementById('izi4y').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
