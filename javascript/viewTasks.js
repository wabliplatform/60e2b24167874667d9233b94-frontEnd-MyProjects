document.getElementById('i3hm').onclick = (event) => {
    ...
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('ixgftl').onclick = (event) => {
    event.preventDefault();
    ...
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('ikbhek').onclick = (event) => {
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('i0er7b').onclick = (event) => {
    event.preventDefault();
    { 
     ...
     location.href= '//' + transitionId;}};document.getElementById('iv0pcc').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
     ...
     location.href= '//' + transitionId;}};document.getElementById('ifn3df').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
     ...
     location.href= '//' + transitionId;}};document.getElementById('i38rcg').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
     ...
     location.href= '//' + transitionId;}};document.getElementById('i7g1v').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
     ...
     location.href= '//' + transitionId;}};window.onload = () => {};