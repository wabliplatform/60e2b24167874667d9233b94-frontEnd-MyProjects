let apiEmployeeApi = new TempApi.EmployeeApi();import TempApi from '../src/index';document.getElementById('iwhz').onclick = (event) => {
    ...
    {  location.href= '/' ;}};document.getElementById('ila5xr').onclick = (event) => {
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('iqxri').onclick = (event) => {
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('ipfpt8').onclick = (event) => {
    event.preventDefault();
    {  location.href= '/' ;}};document.getElementById('ii78v2').onclick = (event) => {
    event.preventDefault();
    {  location.href= '/' ;}};document.addEventListener('aligneImage', function(e) {
...
});document.addEventListener('aligneSurname', function(e) {
  const advanceSelect = document.getElementById('il448r');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
...
});document.addEventListener('aligneName', function(e) {
  const advanceSelect = document.getElementById('irlubk');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('icok09');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
...
});document.addEventListener('aligneImage', function(e) {
  const advanceSelect = document.getElementById('i9rmmc');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('iwm9uk');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ijky1i');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i6m3dh');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('im44zl');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('iqu56l');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ic7tkn');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ima1gv');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i7zkki');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('io7o8f');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ii3a6a');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('iynyxj');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ieupnf');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i15etv');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ig19pr');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ih24aw');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i84zd5');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ih5m6k');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('irzyrd');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ir8rh5');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ij333j');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ivxufv');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ifdajn');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('iun12q');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i99ds');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('ih3ih');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('it1v1');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
  ...
  const advanceSelect = document.getElementById('i9zbyf');
  const selectedElement = advanceSelect.getAttribute('selected-element');
  if (!selectedElement) return;
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    optionElement => {
